...
ts.panel_title(a, "a  Calibration: the 52 hpf tissue sits between the 60° and 75° references", width=88, pad=12)
a.set_ylim(-0.04, 0.72)
...
ymax = a.get_ylim()[1]
a.annotate("60° threshold", (60, ymax * 0.80), textcoords="offset points",
           xytext=(-6, 0), fontsize=ts.FS, color="k", ha="right", va="center")
a.set_xlabel("crossing angle (°)")
a.set_ylabel("density")
ts.panel_title(a, "b  Bimodal: skeletonisation spurs fill the low mode and drag the median down", width=88, pad=12)
