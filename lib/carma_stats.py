"""
CARMA — analysis module for everything except FFT/dominance.
...
Self-check after installing:
    python carma_stats.py          # expect "20/20 checks passed"
"""
...
SEQ = LinearSegmentedColormap.from_list(
    "carma_seq", ["#f2f6fd", "#c3d4f0", "#8fb0e2", "#5b87d1", "#3560ab", "#1d3a6e"]
)
